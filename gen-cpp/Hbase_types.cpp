...
const char* TScan::ascii_fingerprint = "6FA1E3494CF4F9366BC36F37FCFD516B";
const uint8_t TScan::binary_fingerprint[16] = {0x6F,0xA1,0xE3,0x49,0x4C,0xF4,0xF9,0x36,0x6B,0xC3,0x6F,0x37,0xFC,0xFD,0x51,0x6B};
...
uint32_t TScan::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.cacheBlocks) {
    xfer += oprot->writeFieldBegin("cacheBlocks", ::apache::thrift::protocol::T_BOOL, 10);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readBinary(this->columns[_i30]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.columns = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->values.resize(_size31);
            uint32_t _i35;
            for (_i35 = 0; _i35 < _size31; ++_i35)
            {
              xfer += iprot->readBinary(this->values[_i35]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t TAppend::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->columns.size()));
    std::vector<Text> ::const_iterator _iter36;
  ...
  xfer += oprot->writeFieldBegin("values", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    for (_iter37 = this->values.begin(); _iter37 != this->values.end(); ++_iter37)
    {
